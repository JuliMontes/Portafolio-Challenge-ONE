/**
* Función útil al implementarse en funciones con condiciones lógicas que permitan modificar el contenido
* de la página que no sean posibles de modificar con CSS p.ej.
* 
